...
public class FichaPDF {
    ...
    private void AñadirNuevaPaginaHabilidades(PdfPTable table, Document document, PdfWriter writer, String font, int fontSize)
        ...
        //Generamos una nueva.
        document.newPage();
        AddImagenFondo(document, RolemasterFolderStructure.ROLEMASTER_FOLDER + File.separator + "fichas" + File.separator + "RMHP3.png");
    }
    ...
    private void PersonajePagina2PDF(Document document, PdfWriter writer, String font) throws Exception {
        document.newPage();
        AddImagenFondo(document, RolemasterFolderStructure.ROLEMASTER_FOLDER + File.separator + "fichas" + File.separator + "RMHP2.png");
    ...
    void PersonajePagina1PDF(Document document, PdfWriter writer, String font) throws Exception {
        int fontSize = 7;
        AddImagenFondo(document, RolemasterFolderStructure.ROLEMASTER_FOLDER + File.separator + "fichas" + File.separator + "RMHP1.png");
