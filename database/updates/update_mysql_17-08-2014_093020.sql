    ...
    alter table T_APPEARANCE 
        drop constraint UK_hlcvnifaglalnf0dpfbcak1u8;
    ...
    alter table T_CATEGORY_COST 
        drop constraint UK_fcmfkigake2hqq44gyge781xw;
    ...
    alter table T_CHARACTERPLAYER_TEMPORAL_CHARACTERISTICS_ROLLS 
        drop constraint UK_rsdhy70yoehafjvur7w9b2o66;
    ...
    alter table T_PROFESSION_DECISIONS 
        drop constraint UK_li3y57bhuj92ukf2ys827be5j;
    ...
    alter table T_PROFESSION_WEAPON_COST_CHOSEN 
        drop constraint UK_hyu9pvkqjkxlo6ldjah1i6mkk;

    alter table T_PROFESSION_WEAPON_COST_CHOSEN 
        add constraint UK_hyu9pvkqjkxlo6ldjah1i6mkk  unique (weaponsCost_ID);

    alter table T_ROLL 
        drop constraint UK_9r4ehgb8fn2dn3d3sd8xvd4fd;
    ...
    alter table T_ROLL_GROUP 
        drop constraint UK_ec1a2pas67gu5pl4tfelsan0r;
