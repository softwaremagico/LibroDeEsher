...
public class PulpTests extends BasicTest {
	...
	@Test
	public void checkRandomCharacterIndustryCulture() throws MagicDefinitionException,
		...
		Assert.assertEquals(characterPlayer.getCultureDecisions().getAdolescenceCategoriesSelected().size(),
				3);
